<div align="center"><br><img width="847" height="135" alt="Polarius" src="https://github.com/user-attachments/assets/fa227214-86b9-4b76-8118-9a4b9e541bcd" /></div><br>

### 요약  

공동의 목표에 대한 기여증명 화폐 발행구조와 기여량 기반의 참정구조가 결합된 매트릭스 클라이언트로, [Element](https://github.com/element-hq/element-web)를 기반으로 제작되었습니다. 자세한 설명은 [Polarius.md](https://github.com/BROTHERHOOD42/Polarius-web/docs/polarius_kr.md) 문서에서 확인할 수 있습니다.  
