...
// Import isGOVProposalRoom function from RoomHeader
...
const ReactButton: React.FC<IReactButtonProps> = ({ mxEvent, reactions, onFocusChange, onDCADialogOpen }) => {
    ...
    // First check if this is a GOV proposal room - if so, skip DCA checks
    const isGOVProposal = room ? isGOVProposalRoom(room) : false;
    const isDCA = room && !isGOVProposal ? isDCARoom(room) : false;
