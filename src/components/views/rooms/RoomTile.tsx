...
class RoomTile extends React.PureComponent<Props, State> {
    ...
    public render(): React.ReactElement {
        ...
        const isGOVProposal = this.props.room.currentState.getStateEvents("m.room.topic", "")?.getContent()?.topic?.includes("[GOV_PROPOSAL]");
        const pollStatusIndicator = !this.props.isMinimized && isGOVProposal ? (
